Object.observe||function(d,w,p){var h,g,C="add update delete reconfigure setPrototype preventExtensions".split(" "),D=p.Node?function(a){return a&&a instanceof p.Node}:function(a){return a&&"object"===typeof a&&"number"===typeof a.nodeType&&"string"===typeof a.nodeName},E=w.isArray||function(a){return function(b){return"[object Array]"===a.call(b)}}(d.prototype.toString),l=w.prototype.indexOf?function(a,b,c){return b.indexOf(a,c)}:function(a,b,c){for(c=c||0;c<b.length;c++)if(b[c]===a)return c;return-1},
r="undefined"!==typeof p.Map&&Map.prototype.forEach?function(){return new Map}:function(){var a=[],b=[];return{size:0,has:function(c){return-1<l(c,a)},get:function(c){return b[l(c,a)]},set:function(c,e){var f=l(c,a);-1===f?(a.push(c),b.push(e),this.size++):b[f]=e},"delete":function(c){c=l(c,a);-1<c&&(a.splice(c,1),b.splice(c,1),this.size--)},forEach:function(c,e){for(var f=0;f<a.length;f++)c.call(e,b[f],a[f],this)}}},x=d.keys||function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b},
y=p.requestAnimationFrame||p.webkitRequestAnimationFrame||function(){var a=+new Date;return function(b){return setTimeout(function(){b(+new Date-a)},17)}}(),t=function(a,b,c){if(a.handlers.size){var e,f,k,u=a.values,d=0,h,g,m,n;e=a.properties.slice();f=e.length;for(k=x(b);d<k.length;)if(g=k[d++],h=l(g,e),m=b[g],-1===h)q(b,a,{name:g,type:"add",object:b},c),a.properties.push(g),u.push(m);else if(n=u[h],e[h]=null,f--,n===m?0===n&&1/n!==1/m:n===n||m===m)q(b,a,{name:g,type:"update",object:b,oldValue:n},
c),a.values[h]=m;for(d=e.length;f&&d--;)null!==e[d]&&(q(b,a,{name:e[d],type:"delete",object:b,oldValue:u[d]},c),a.properties.splice(d,1),a.values.splice(d,1),f--)}},z=function(){h.size&&(h.forEach(t),g.forEach(v),y(z))},v=function(a,b){a.changeRecords.length&&(b(a.changeRecords),a.changeRecords=[])},A=function(a,b){2>arguments.length&&(b=h.get(a));return b&&b.notifier||{notify:function(c){c.type;var b=h.get(a);if(b){var f={object:a},k;for(k in c)"object"!==k&&(f[k]=c[k]);q(a,b,f)}},performChange:function(c,
